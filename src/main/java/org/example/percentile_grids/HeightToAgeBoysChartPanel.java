...
public class HeightToAgeBoysChartPanel extends JPanel {
    ...
    public HeightToAgeBoysChartPanel() {
        ...
        XYSeries[] centileSeries = new XYSeries[]{
                createSeries("3rd Centile", x, new double[]{90.5, 94, 97, 100.5, 103.2, 106.2, 109, 111.8, 114.8, 117.5, 120, 122.5, 124.8, 127, 129, 131.6, 133.8, 136, 138.5, 141.5, 145, 148.2, 152, 155.6, 158.5, 161, 162.9, 164, 165.1, 166, 166.6}),
                createSeries("10th Centile", x, new double[]{92.6, 96.4, 99.7, 103, 106, 108.7, 112, 115, 117.8, 120.8, 123.6, 125.8, 128.3, 131, 133, 135.5, 138, 140.2, 143.4, 146.4, 149.7, 153.3, 157, 159.9, 162.9, 165.1, 167, 168, 169, 170, 170.5}),
                createSeries("25th Centile", x, new double[]{95, 98.5, 102, 105.3, 108.8, 111.8, 114.9, 118, 121, 123.6, 126.7, 129.5, 132, 134.9, 137, 139.6, 142, 144.9, 147.8, 151, 154.7, 158, 161.7, 164.8, 167.5, 169.5, 171, 172.2, 173.3, 173.9, 174.3}),
                createSeries("50th Centile", x, new double[]{97.5, 101, 105, 108.3, 112, 115, 118.5, 121.6, 124.4, 127.5, 130.5, 133.3, 136.3, 139, 141.4, 144, 146.7, 149.6, 153, 156.5, 160, 163.8, 167, 170, 172.5, 174, 175.6, 176.8, 177.6, 178.2, 178.5}),
                createSeries("75th Centile", x, new double[]{100, 104, 107.6, 111, 115, 118, 121.7, 124.5, 128, 131, 134, 137.2, 140.1, 143.2, 145.9, 148.7, 151.2, 154.8, 158, 161.3, 165.7, 169.6, 172.7, 175.3, 177.5, 179, 180.1, 181.4, 182, 182.5, 183}),
                createSeries("90th Centile", x, new double[]{102.5, 106.5, 110.2, 114, 117.4, 121.5, 124.9, 127.8, 131.4, 134.5, 137.5, 140.7, 143.8, 146.9, 149.7, 152.5, 155.5, 159, 162.8, 166.5, 170.8, 174.6, 177.6, 180, 182, 183.3, 184.5, 185.5, 186, 186.5, 187}),
                createSeries("97th Centile", x, new double[]{104.5, 107.8, 112.7, 116.6, 120.5, 124, 127.8, 131, 134.5, 137.8, 141, 144.5, 147.6, 151.6, 153.8, 156.8, 159.9, 163.4, 167.2, 171.3, 175.6, 179.4, 182.4, 184.7, 187.5, 188.5, 189.5, 190, 190.4, 190.5, 190.7})
        };
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("Height for age (Boys)", "Age (years)", "Height (cm)", dataset);
        chart.removeLegend();
        ...
        saveButton.addActionListener(e -> {
            try {
                ...
                File file = new File(desktopDir, "HeightToAgeBoysChart .png");
                ChartUtils.saveChartAsPNG(file, chartPanel.getChart(), 1600, 900);
                JOptionPane.showMessageDialog(this, "Chart saved on desktop as HeightToAgeBoysChart.png");
            } catch (Exception ex) {
